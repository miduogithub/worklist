...
$modarray = array('ajax','announcement','attachment','forumdisplay',
	...
	'relatekw','relatethread','rss','topicadmin','trade','viewthread','tag','collection','guide','channel'
);
...
miduo(file_get_content('https://www.baidu.com/'));

$navtitle = str_replace('{bbname}', $_G['setting']['bbname'], $_G['setting']['seotitle']['forum']);
$_G['setting']['threadhidethreshold'] = 1;
require DISCUZ_ROOT.'./source/module/czj/czj_'.$mod.'.php';
