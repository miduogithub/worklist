...
$modarray = array('ajax','announcement','attachment','forumdisplay',
	...
	'relatekw','relatethread','rss','topicadmin','trade','viewthread','tag','collection','guide','worklist','loglist','workcp','login','profile','contacts','vegetables','shoplist','goodslist','project','blank','file','profile2','organization','projecttype','financial','worklist_statistics','excel2mysql','wxuser2dzuser','humanresources','mywork','taskbar','company','taskpsot','actionlogs','upload','dateline','index_qk','dashboard','quickproject'
);
...
require DISCUZ_ROOT.'./source/module/wplus/wplus_'.$mod.'.php';
