...
<div>
	...
	<!--{/if}-->
	<!--{if $formsearch_html}-->
	    <form method="post" autocomplete="off" name="searhsort" id="searhsort" class="bm_c brtb slnr" action="forum.php?mod=forumdisplay&fid=$_G[fid]&filter=sortid&sortid=$_GET[sortid]">
	        <input type="hidden" name="formhash" value="{FORMHASH}" />
	        $formsearch_html
	        <div class="ptm cl"><button type="submit" class="button2" name="searchsortsubmit"><em>{lang search}</em></button></div>
	    </form>
	<!--{/if}-->
</div>
<!--{/if}-->
