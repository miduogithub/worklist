...
$modarray = array('ajax','announcement','attachment','forumdisplay',
	...
	'relatekw','relatethread','rss','topicadmin','trade','viewthread','tag','collection','guide','getorders','sendweixinmessage','authorizedseller','login','test','wxuser2dzuser','crontabs','crontabs_push_project_mission_ing','wxcp','checkin','askforleave');
...
require DISCUZ_ROOT.'./source/module/wx/wx_'.$mod.'.php';
