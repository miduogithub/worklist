...
//include './source/class/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php';

require_once './source/class/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.php';
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIBQxH5EWm2j7u"; // AccessKeyId

        $accessKeySecret = "DukcpSKeZE8hpENsBDYGT7Y5Pv5lKn"; // AccessKeySecret
