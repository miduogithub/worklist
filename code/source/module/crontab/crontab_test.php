...
foreach($openidlist as $openid) {
	...
	//$count = $membermissioninfo[$weixinmemberinfo_uid]['missionstatus1count'];
...
/*
	$membermissioninfo = get_user_missionlist_by_uid($weixinmemberinfo_uid);
...
*/
	...
	if($count > '0') {//有新任务
		...
		if(!empty($weixinmemberinfo_uid) && $memberinfo['groupid'] == '1') {
