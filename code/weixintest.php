...
$modarray = array('ajax','announcement','attachment','forumdisplay',
	...
	'relatekw','relatethread','rss','topicadmin','trade','viewthread','tag','collection','guide','getorders','sendweixinmessage','authorizedseller','login','test');
...
require DISCUZ_ROOT.'./source/module/weixintest/weixintest_'.$mod.'.php';
